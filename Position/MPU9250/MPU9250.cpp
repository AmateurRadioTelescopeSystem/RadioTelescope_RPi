...
int8_t MPU9250::i2cAddr(int address)
{
...
uint8_t MPU9250::writeByte(uint8_t address, uint8_t registerAddress, uint8_t data)
{
	i2cAddr(address);
...
uint8_t MPU9250::readByte(uint8_t address, uint8_t registerAddress)
{
	i2cAddr(address);
...
uint8_t MPU9250::readBytes(uint8_t address, uint8_t registerAddress, uint8_t count,
		uint8_t *dest)
{
	i2cAddr(address);
